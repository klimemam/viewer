...
それぞれ別の作業。** 前提文書: docs/browse-inventory.md(裁定の分母)、
docs/browse-topbar-design.md §10(実装方針の記録)、docs/split-plan.md §3/§9
(持ち出し単位と判断1)、docs/input-adapters.md §3.6.4(述語の分離)、
docs/remote-headerless-design.md §5(直近で継ぎ目が動いた実例)。
