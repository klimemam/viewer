...
> 断るものの一覧は [input-adapters.md §3.6.2](../adapters/input-adapters.md)。この節が
...
→ [background/media/media-support.md](../../background/media/media-support.md) へ移動 (2026-08-17)。
...
経緯と検討: [background/media/media-support.md](../../background/media/media-support.md)
