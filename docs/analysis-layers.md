...
<!-- 【実装 2026-08-10 — PR #129】上の2行は着地した (map はまだ: 器は #49)。
...
| dark を引いた flat の固定パターン | **SetAnalyzer** | 裸の `PRNU` (+ set タグ: `— set: image n/N, dark n/N`) | **着地済み (PR #129)**。Set Analysis パネル。タグは set 名も名乗る (不変条件 (a)) |
